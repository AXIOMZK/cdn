...
vector<int> MCMF::SeverNOSetToVector(const set<SeverNoAndAroundBandwidth, Bandwidth_From_Small_To_Big> &sever)
{
    vector<int> vector1;
    for (auto it = sever.begin(); it != sever.end(); ++it)
    {
        vector1.push_back((*it).ServerNo);
    }
